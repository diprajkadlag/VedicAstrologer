...
import AppPreferencesControls, {
  AppLanguageSelect,
} from "@/components/ui/AppPreferencesControls";
import BirthForm, {
...
const messages = defineMessages({
  en: {
    ...
    featureChartsBody: "Switch between North and South Indian zodiac-chart layouts.",
    featureAnalysisTitle: "Vedic astrology analysis",
    featureAnalysisBody:
      "Explore houses, lunar mansions, traits, and Vimshottari periods.",
    ...
    brand: "Vedic Astrology Observatory",
    ...
    planetSaturn: "Saturn",
    planetRahu: "North Node",
    planetKetu: "South Node",
    corePada: "{nakshatra} quarter {pada}",
    coreNakshatra: "{nakshatra} · house {house}",
    coreNakshatraPada: "{nakshatra} quarter {pada} · house {house}",
    webglSphere: "WebGL celestial sphere",
    geocentricCosmos: "Geocentric cosmos",
    simulatedSky: "Simulated sky",
    natalInterpretation: "Natal Vedic astrology interpretation",
    methodology: "Lahiri ayanamsa · mean nodes · whole-sign houses",
    accuracy:
  ...
  de: {
    ...
    featureChartsBody: "Wechsle zwischen nord- und südindischer Tierkreiszeichen-Darstellung.",
    featureAnalysisTitle: "Analyse der vedischen Astrologie",
    ...
    calculateError: "Das Geburtshoroskop konnte nicht berechnet werden. Prüfe die Geburtsdaten.",
    instantError: "Der gewählte Zeitpunkt konnte nicht berechnet werden.",
    brand: "Observatorium für vedische Astrologie",
    title: "Erkunde den Himmel deines Geburtsmoments.",
    subtitle: "Entdecke ein siderisches Lahiri-Geburtshoroskop mit geozentrischem 3D-Kosmos, traditionellen Darstellungen und transparenter regelbasierter Analyse.",
    ready: "Vollständiges Observatorium · Bereit",
    birthEntry: "Geburtsdaten eingeben",
    updateTitle: "Natalen Ausgangspunkt aktualisieren",
    updateBody: "Eine neue Berechnung ersetzt das Geburtshoroskop, setzt den Zeitnavigator zurück und aktualisiert alle Ansichten und Deutungen.",
    ...
    planetJupiter: "Jupiter",
    planetSaturn: "Saturn",
    planetRahu: "Nordknoten",
    planetKetu: "Südknoten",
    corePada: "{nakshatra} Viertel {pada}",
    coreNakshatra: "{nakshatra} · Haus {house}",
    coreNakshatraPada: "{nakshatra} Viertel {pada} · Haus {house}",
    webglSphere: "WebGL-Himmelssphäre",
    geocentricCosmos: "Geozentrischer Kosmos",
    simulatedSky: "Simulierter Himmel",
    natalInterpretation: "Deutung der vedischen Astrologie",
    methodology: "Lahiri-Ayanamsa · mittlere Mondknoten · Ganzzeichen-Häuser",
