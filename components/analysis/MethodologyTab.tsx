...
const COPY: Readonly<Record<AppLocale, MethodologyCopy>> = {
  en: {
    ...
    intro:
      "This page separates reproducible astronomical calculations from traditional Vedic-astrology interpretation. Passing the audit means the chart agrees with its own mathematical rules; it does not prove that astrology predicts personality or events.",
    ...
    calculated: [
      ...
      "A location-sensitive ascendant, whole-sign houses, 27 lunar mansions and four quarters.",
      "Mean North and South Nodes, always opposite; true-node results can differ near boundaries.",
      "Vimshottari major periods and sub-periods using a disclosed 365.25-day-year convention.",
    ],
    interpretationTitle: "What is traditional interpretation",
    interpretation: [
      "Personality, house, planetary-body and planetary-period text is rule-based symbolic synthesis—not a measured fact about the person.",
      ...
      "Transit scores are transparent editorial summaries, not probabilities, risk estimates or event forecasts. Planetary periods are timelines and are not scored.",
    ],
    omittedTitle: "Currently not calculated",
    omitted:
      "Sixfold strength assessment, divisional charts such as the ninth-division chart, classical aspects, conjunction orbs, combustion, traditional combinations, eight-part point assessment, rectification and event probabilities. Educational descriptions of these terms must not be mistaken for chart results.",
    ...
    critical: [
      ...
      "Birth-time uncertainty can materially change the ascendant and houses; rounded times deserve extra caution.",
  ...
  de: {
    ...
    intro:
      "Diese Seite trennt reproduzierbare astronomische Berechnungen von traditioneller vedischer Deutung. Ein bestandener Audit bedeutet, dass das Geburtshoroskop seinen eigenen mathematischen Regeln entspricht; er beweist nicht, dass Astrologie Persönlichkeit oder Ereignisse vorhersagen kann.",
    auditTitle: "Konsistenzprüfung des Geburtshoroskops",
    ...
    warnings: "Warnungen",
    auditBoundary:
      "Dies ist ein struktureller Software-Audit, kein Beleg für Vorhersagekraft. Weder diese App noch diese Sitzung hat einen unabhängigen Vergleich mit Swiss Ephemeris oder JPL durchgeführt. Prüfen Sie grenznahe Geburtshoroskope mit einer zertifizierten Ephemeride.",
    ...
    calculated: [
      "Scheinbare geozentrische Positionen von Sonne, Mond und Planeten mit Astronomy Engine; deren angegebenes Genauigkeitsziel liegt bei ungefähr ±1 Bogenminute.",
      ...
      "Ein ortsabhängiger Aszendent, Ganzzeichenhäuser, 27 Mondstationen und vier Viertel.",
      "Mittlere Positionen von Nord- und Südknoten, stets einander gegenüber; nahe einer Grenze können Ergebnisse mit wahren Mondknoten abweichen.",
      "Vimshottari-Haupt- und Unterperioden nach der offengelegten Konvention eines Jahres mit 365,25 Tagen.",
    ],
    interpretationTitle: "Was traditionelle Deutung ist",
    interpretation: [
      "Texte zu Persönlichkeit, Haus, Himmelskörper und Planetenperiode sind regelbasierte symbolische Synthesen—keine gemessenen Tatsachen über eine Person.",
      ...
      "Transitwerte sind transparente redaktionelle Zusammenfassungen, keine Wahrscheinlichkeiten, Risikoschätzungen oder Ereignisprognosen. Planetenperioden werden nicht bewertet.",
    ],
    omittedTitle: "Derzeit nicht berechnet",
    omitted:
      "Sechsfache Stärkebewertung, Teilhoroskope wie das neunte Teilhoroskop, klassische Aspekte, Konjunktionsorben, Verbrennung, traditionelle Kombinationen, achtteilige Punktbewertung, Geburtszeitkorrektur und Ereigniswahrscheinlichkeiten. Lehrtexte zu diesen Begriffen dürfen nicht mit Ergebnissen Ihres Geburtshoroskops verwechselt werden.",
    ...
    critical: [
      ...
      "Eine unsichere Geburtszeit kann Aszendent und Häuser wesentlich verändern; gerundete Zeiten erfordern besondere Vorsicht.",
